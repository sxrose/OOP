...
public abstract class Expression implements Cloneable {
     ...
     * and only if they are the same object or structurally constitute the same expression tree up
     * to associativity.
     *
    ...
    /**
     * Indicates whether some other object is "equal to" this expression. Two expressions are the
     * same if and only if they are the same object or structurally constitute the same expression
     * tree up to associativity.
     *
